...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.0.19/dist/sweetalert2.all.min.js"></script><script src="https://kit.fontawesome.com/4f3ce16e3e.js" crossorigin="anonymous"></script><script src="https://unpkg.com/typeit@8.7.0/dist/index.umd.js"></script><link rel="stylesheet" href=""><script src="https://unpkg.com/scrollreveal"></script>
...
--gaya-font4: 'Quicksand', sans-serif;
}
...
section .wp::after{content:"";position:absolute;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,.55);}
.first .wp::after {background:rgba(0,0,0,.7)}

h1 {font-size: 1.6rem;font-family:var(--gaya-font4);} h3 {font-size: 1.05rem;}
...
b.putih{text-shadow:none;padding-left:3px;padding-right:3px;background:white;}
...
p.anm{text-align:left;margin:0 60px;margin-left:55px;margin-top:-33px}
...
#judulakhir{z-index:100;font-size:28px;font-family:var(--gaya-font3);transition:all .5s ease}
...
section > p span{text-align:center !important}
...
.swal2-modal{box-shadow: rgba(255,255,255, 0.3) 0px 7px 29px 0px;background:rgba(0,0,0,.9);max-width:320px;border:.5px solid #fff;border-radius:18px;top:-50px;}
...
<body>
   ...
   <audio src="17mashup.mp3" id="linkmp3" class="sembunyi"></audio>
   
  <section class="first">
       <div class="wp"><img src="https://i.ibb.co/vh1mySy/2.jpg"/></div>
       <img id="first_stiker" class="stiker fade-in" src="https://feeldreams.github.io/g5.gif"/>
       <h1 class="title">Aloo kamuuu! 🫶</h1>
       <p class="flip">Ada hal yang mau aku sampein..</p>
       <p class="slide-up"><i>Lanjut ke bawah yaa! ✨</i></p>
  </section>
  
  <!--<section>
      <div class="wp"><img src="https://feeldreams.github.io/buatkamuaja/5.jpg"/></div>
      <img class="stiker fade-in" src="https://feeldreams.github.io/cilukba.gif"/>
      <h3 class="title">Mau Tau Kenapa<br>Aku Milih Kamu? Ã°Å¸Â«Â¶</h3>
  </section>-->
  
  <section>
      <div class="wp"><img src="https://i.ibb.co/xgyDVLh/1.jpg"/></div>
      <!--<img class="stiker fade-in" src="https://feeldreams.github.io/cilukba.gif"/>-->
      <div id="scroll-container" class="title" style="height: 400px; margin-top:-20px; overflow: auto;">
      	<p id="textsec2" class="anm" style="margin-top:0">Aku mau bilang terimakasih ke kamu karena udah nerima aku apa adanya 🤍<br><br>Maafin aku ya kalo aku belum bisa jadi yang terbaik buat kamu, tapi aku bakal berusaha untuk menjadi yang terbaik buat kamu..<br><br><b class="garismerah">Tengcyuuu</b> ya sayangkuu, aku gabisa berhenti bilang aku sayanggg kamuu, ya karena aku memang sesayang itu sama kamu, kamu jangan pergi dari hidup aku yaaa? 🫠<br><br>Oh yaa kamu tau engga? aku ga pernah bosen dan ga akan pernah bosen buat bilang <b class="putih merah">i love u</b> ke kamu,<br><br><b class="garismerah">Aku pacar kamu</b>, tetapi bukan cuma pacar yang nemenin kamu waktu kamu bahagia aja, tapi waktu kamu sedih juga..<br><br>Kasih tau aku kalo kamu ada masalah, okeii? jangan takut ngerasa terbebani karena itu engga sama sekali,<br><br><i><b class="merah">i'm here</b>  as your home</i>, aku bakal jadi tempat sandaran waktu kamu sedih. jangan pernah ngerasa sendiri yaa?<br><br><b class="putih merah">aku sayang kamuuu 🥰</b><br><br><span><b class="kuning">Terakhir</b>, <i>i'm so lucky to have u,<br>jangan pernah pergi dari aku,<br><b class="gariskuning">i love u more</b> than anything</i> 🥰💗✨🫶</span></p>
      </div>
  </section>
  
  <section>
  	<div class="wp"><img src=""/></div>
      <img id="stikerdouble" class="stiker stakhir fade-in" src="https://feeldreams.github.io/mndkat.gif"/>
      <img id="stikerdouble2" class="stakhir" style="display:none" src="https://feeldreams.github.io/bwa2.gif"/>
      <img id="stikerdouble3" class="stakhir" style="display:none" src="https://feeldreams.github.io/mikir.gif"/>
      <img id="stikerdouble4" class="stakhir" style="display:none" src="https://feeldreams.github.io/pandaketawa2.gif"/>
      
      <h3 id="textsec3" class="anm title">Makasii udah jadi<br>yang terbaik buat aku </h3>
      <h3 id="textsec3b" class="anm">Oh iyaa, Aku Punya<br>Pantun Buat Kamu </h3>
      <p id="teksnimasi">Membeli Barang Antik,<br>di Kota Cilacap,<br>Hai Nona <i>Cantik</i>,<br>Give Me Your <b>PAP</b> </p>
    <div id="Tombol2">
       <a id="By2" onClick="fungsimau2()">Boleh</a>
       <a id="Bn2" onClick="btn='Bn2';fungsibaru(btn)">Gaboleh!</a>
    </div>
  </section>

  <section id="iniakhir">
  	<div class="wp"><img src=""/></div>
      <img id="stikerakhir" class="stiker stakhir fade-in" src="https://feeldreams.github.io/lompatin.gif"/>
      <img id="stikerakhir2" class="stakhir" style="display:none" src="https://feeldreams.github.io/emawh.gif"/>
      <h1 id="judulakhir">Yeayy! </h1>
      <p id="kalimatakhir">Makasii yaaa </p>
      <p id="palingakhir">Jangan lupa kirim PAP-nya<br>ke WhatsApp aku! </p>
      <div id="TombolWA">
  ...
  <a id="iniwa" class='tomKirim' href='https://api.whatsapp.com/send?phone=&text=https%3A%2F%2Fs.id%2Fbukabentarya2'>
...
function tes(){
  if(fungsi==0){
    ...
    fungsi = 1;
    skrg++;
    if(skrg==2){skrg++;/*setTimeout(smn,1200);*/}
...
function teksmuncul(){
  //teksjudulakhir2 = "I Love You ÃƒÂ¢Ã…â€œÃ‚Â¨";
...
async function mulaiyuk(){
	await swals.fire('Klik OK yaa!');
    audio.play();
    window.scrollTo(0, 0);
...
function autoScroll() {
  //if (scrollContainer.scrollTop < textContainer.clientHeight - scrollContainer.clientHeight) {
//    scrollContainer.scrollTop += 1; // Menggeser scroll ke bawah
 // } else {
    scrollContainer.scrollTop += 10; // Kembali ke awal ketika mencapai akhir teks
  //}
}
